...
Example
AND(
    tblSales[Revenue] > 1000,
    tblSales[Quantity] >= 10
)
...
Example
IFERROR(
    tblSales[Revenue] / tblSales[Quantity],
    0
)
...
1)create a new column in tblBudget ⇒ to bring Qtr name to budget table
